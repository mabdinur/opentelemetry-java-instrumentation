...
/**
 * ** Add {@literal}TraceMethod to method declarations to wrap method calls in a span
 *
 * @since 0.5.0
 */
...
public @interface TraceMethod {
  ...
  /**
   * Event or Span name <br>
   * If this value is not set, the method name will be used
   */
  String name() default "";
